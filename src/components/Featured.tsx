const credentials = [
  ...
  },
  {
    ...
    desc: "Мастер-классы Aravia «Биомиметический уход: Восстановление и защита кожи после интенсивных процедур»",
  },
];
  ...
  return (
    <div className="flex flex-col lg:flex-row lg:justify-between lg:items-center min-h-screen px-6 py-12 lg:py-0 bg-white">
      <div className="flex-1 h-[400px] lg:h-[800px] mb-8 lg:mb-0 lg:order-2">
        <img
          src="https://cdn.poehali.dev/projects/5cf78603-bd8c-4dbb-a590-ef796f6c2cd4/bucket/a321a342-1344-443e-80cf-85f4d805a7cd.jpg"
          alt="Мастер"
